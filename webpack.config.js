...
const aliases = Object.entries(dfxJson.canisters).reduce(
    (acc, [name, _value]) => {
        ...
        const networkName = import.meta.env["DFX_NETWORK"] || "local";
    ...
    return {
        ...
        module: {
            rules: [
                ...
                {test: /\.(svg|png|jpg)$/, use: ['url-loader']},
        ...
        plugins: [
            ...
            new webpack.EnvironmentPlugin([
                "REACT_APP_MARKET_ID",
                "REACT_APP_STORAGE_CANISTER_ID",
                "REACT_APP_LEDGER_CANISTER_ID",
                "REACT_APP_HOST",
                "REACT_APP_WICP_CANISTER_ID",
                "REACT_APP_MINT_CANISTER_ID"
            ]),
            new CopyPlugin({
                patterns: [
                    {
