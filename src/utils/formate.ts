...
export const initDefaultLiquidityToken = ({fromToken, toToken, token0, token1}): Props => {
...
export const createBucket = async () => {
    ...
    const setting = {
        accessKeyId: "AKIATKDVSHI5DOOV3Z5W",
        secretAccessKey: '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',
    };
    // @ts-ignore
    AWS.config.update(setting);
    // @ts-ignore
    return new AWS.S3({params: {Bucket: 'inft'}});
